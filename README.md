...
I did more and more until now I have a regular season, and playoffs. There are now 24 teams, and obviously many more players. Games are won and lost based on an algorithm that determines how many points a player scores based on their skills ratings. Then the team sums each players' score for a final score.
